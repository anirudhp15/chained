...
const nextConfig = {
  ...
  async headers() {
    ...
    const prodCSP = [
      ...
      "worker-src 'self' blob:",
      "style-src 'self' 'unsafe-inline' fonts.googleapis.com https://*.gstatic.com https://*.google.com https://recaptcha.google.com",
      "img-src 'self' data: blob: *.amazonaws.com *.convex.cloud *.clerk.accounts.dev *.clerk.dev *.chained.chat *.clerk.com img.clerk.com *.clerk.services https://*.gstatic.com https://*.google.com https://*.googleusercontent.com https://recaptcha.google.com",
      "connect-src 'self' *.convex.cloud *.posthog.com *.clerk.accounts.dev *.clerk.dev *.chained.chat *.clerk.com accounts.google.com github.com api.github.com www.linkedin.com https://*.google.com https://*.recaptcha.net https://recaptcha.google.com https://*.googletagmanager.com https://*.gstatic.com worker.clerkprod-cloudflare.net clerk.services wss:",
      "font-src 'self' fonts.gstatic.com https://*.google.com",
      "media-src 'self' blob:",
      "frame-src 'self' https://*.google.com https://*.recaptcha.net https://recaptcha.google.com https://*.gstatic.com *.clerk.com clerk.chained.chat",
      "child-src 'self' https://*.google.com https://*.recaptcha.net https://recaptcha.google.com",
      "object-src 'none'",
      "base-uri 'self'",
